import { getDelayThresholdSeconds } from "./node-delay.utils";
...
export const getEnvVariables = () => ({
  ...
  acceptableDelaySeconds: getDelayThresholdSeconds(
    process.env.NEXT_PUBLIC_ACCEPTABLE_DELAY_SECONDS,
  ),
  partners:
    typeof process.env.NEXT_PUBLIC_PARTNERS === "string" &&
    process.env.NEXT_PUBLIC_PARTNERS.length > 0
