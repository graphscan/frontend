...
import { StyledWarning, WarningContainer, WarningCloseButton } from './warning.styled';
...
export const Warning: React.FC<Props> = ({ title, description, hasBorderBottom }) => {
  ...
  return showWarning ? (
    <StyledWarning hasBorderBottom={Boolean(hasBorderBottom)}>
      <WarningContainer>
        ...
        {Boolean(description) && <p className="warning-description">{description}</p>}
      </WarningContainer>
