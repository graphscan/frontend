...
import { Wrapper, Input, Button, Label, Description, Account } from './radio.styled';
...
export const Radio: React.FC<Props> = ({ id, name, label, currentChecked, onChange }) => {
  ...
  return (
    <Wrapper role="radio" aria-checked={checked} checked={checked} tabIndex={0} onKeyPress={handleKeyPress}>
      <Input
        onChange={onChange}
        ref={ref}
        type="radio"
