import { useSubgraphDetails } from './subgraph-details-lite.service';
import {
  ContainerPad,
...
import { createTitleWithTooltipDescription, renderDeploymentId } from '../../../../../../utils/table.utils';
...
export const SubgraphDetailsLite: React.FC<Props> = (props) => {
  useTooltip();
            ...
            <Table>
              <tbody>
                ...
                <Tr>
                  ...
                  <Td>
                    <span data-tip={deploymentId}>{renderDeploymentId(true)(deploymentId)}</span>
                  </Td>
                </Tr>
                <Tr>
                ...
                <Tr>
                  <Th>{createTitleWithTooltipDescription('Subgraph Curators', 'Active (Total)')}</Th>
                  <Td>{`${subgraphCuratorsCount.active} (${subgraphCuratorsCount.total})`}</Td>
                </Tr>
                <Tr>
                  <Th>{createTitleWithTooltipDescription('Deployment Curators', 'Active (Total)')}</Th>
            ...
            <Table>
              <tbody>
                <Tr>
                  ...
                  <Td>
                    <span data-tip={tooltipNumberContent(signals)}>{formatNumber(signals)}</span>
                    <Postfix> GRT</Postfix>
                  </Td>
                </Tr>
                <Tr>
