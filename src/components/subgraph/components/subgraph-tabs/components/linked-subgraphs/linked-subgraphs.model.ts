...
const titles: Record<
  Exclude<keyof LinkedSubgraphsRow, 'id' | 'versionId' | 'key' | keyof SubgraphStates>,
  string
> = {
  img: 'Img',
  displayName: 'Name',
...
export const transformToCsvRow = ({ id, displayName, img, createdAt, deploymentId }: LinkedSubgraphsRow) => ({
  [titles.img]: img,
