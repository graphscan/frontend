import { AccountCard, Props as AccountCardData } from './components/account-card/account-card.component';
import {
  DescriptionCard,
...
export const SubgraphCards: React.FC<Props> = ({ accountCardData, descriptionCardData }) => {
  useTooltip();
