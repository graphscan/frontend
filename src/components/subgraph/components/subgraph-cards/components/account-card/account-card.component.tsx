  ...
  return (
    <Container>
      <Left>
        <Image>
          {image ? (
            <img src={image} alt="Subgraph image" width="100" height="100" onError={onImageLoadError} />
          ) : (
            <img src="/images/no-data.svg" alt="No data image" width="100" height="100" />
          )}
        </Image>
        <Name>subgraph</Name>
      </Left>
          ...
          <Description>
            <DescriptionContainer>
              <div>
                ...
                <Text>Owner</Text>
                <Accounts>
                  <Link href={`/profile?id=${ownerId}#subgraph-owner-subgraphs`} passHref>
                    <AccountLink
