...
import { DelegatorDelegationsRowLite } from './delegator-delegations-lite.model';
...
} from '../../../../../../model/web3-transations.model';

export const useDelegationTransactions = (id: string, currentAddress: string | null) => {
  ...
  const createTransactionButtonRenderer = useCallback(
    (transaction: DelegationTransaction) => (_: undefined, row: DelegatorDelegationsRowLite) => {
