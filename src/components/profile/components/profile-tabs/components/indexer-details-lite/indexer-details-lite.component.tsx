import { useIndexerDetails } from './indexer-details-lite.service';
import { Container, MapContainer, Warning, WarningContainer } from './indexer-details-lite.styled';
...
export const IndexerDetailsLite: React.FC<Props> = ({ id }) => {
  useTooltip();
            ...
            <Tr>
              <Th>
                {createTitleWithTooltipDescription(
                  ...
                  `Indexer’s query fee rebates.`,
                )}
              </Th>
              <Td>
                <span data-tip={tooltipNumberContent(queryFeeRebates)}>{formatNumber(queryFeeRebates)}</span>
                <Postfix> GRT</Postfix>
              </Td>
            </Tr>
          </tbody>
