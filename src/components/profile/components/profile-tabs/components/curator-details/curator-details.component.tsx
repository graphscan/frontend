              ...
              <tbody>
                <Tr>
                  <Th>
                    {createTitleWithTooltipDescription(
                      'P/L GRT',
                      'Unsignaled GRTs minus signaled GRT. Includes realized and unrealized P/L.',
                    )}
                  </Th>
                  <Td>
                    <span
                      data-tip={tooltipNumberContent(PLGrt)}
                      data-text-color={PLGrt > 0 ? '#4cd08e' : PLGrt < 0 ? '#e25776' : ''}
                      style={{ color: PLGrt > 0 ? '#4cd08e' : PLGrt < 0 ? '#e25776' : '' }}
                    >
                      {formatNumber(PLGrt)}
                    </span>
                    <Postfix> GRT</Postfix>
                ...
                <Tr>
                  <Th>
                    {createTitleWithTooltipDescription('Realized P/L', 'Received P/L from unsignaling.')}
                  </Th>
                  <Td>
                    <span data-tip={tooltipNumberContent(realizedPLGrt)}>{formatNumber(realizedPLGrt)}</span>
                    <Postfix> GRT</Postfix>
                  </Td>
                </Tr>
                <Tr>
                  <Th>
                    {createTitleWithTooltipDescription(
                      'Unrealized P/L',
                      'Potential P/L from current signals.',
                    )}
                  </Th>
                  <Td>
                    <span data-tip={tooltipNumberContent(unrealizedPLGrt)}>
                      {formatNumber(unrealizedPLGrt)}
                    </span>
                    <Postfix> GRT</Postfix>
                  </Td>
                </Tr>
