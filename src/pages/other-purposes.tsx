...
const OtherPurposes: NextPage = () => {
  return (
    <>
      ...
      <StyledDocs>
        <h1>Other purposes underlying the processing of personal data by Graphscan.io </h1>
        <p>
          Web3alert.io may process the personal data of the users of the Website or others, in the pursuit of
          the following purposes, in addition to those mentioned in the privacy policy of the Website:
        </p>
        <ol>
          <li>
            Human Resources
            <ul>
              ...
              <li>Human resource management (e.g. access and attendance management, time management).</li>
              <li>Processing and payment of salaries.</li>
              <li>Exercise of disciplinary power.</li>
              <li>Performance evaluation.</li>
              <li>Evaluation of work capacity, within the scope of occupational medicine.</li>
              <li>Assessing the worker's suitability to carry out the respective functions.</li>
          ...
          <li>
            ...
            <ul>
              ...
              <li>Providing tax-related information, including sending information to the Tax Authority.</li>
            </ul>
          </li>
          <li>
            ...
            <ul>
              <li>
                Compliance and enforcement of applicable legislation, regulators requests, sanctions and PEP
                screenings, fraud suspicious investigations (including anti-cheat logs) and general Website
                usage.
              </li>
            </ul>
          </li>
